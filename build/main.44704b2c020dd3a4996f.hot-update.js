...
function onGameEvent(e) {
    switch (e.type) {
        ...
        case "playerHit":
            ...
            createjs.Tween.get(hitIndicator, { useTicks: true }).to({ alpha: 0 }, 10).wait(100).call(() => { createjs.Tween.removeTweens(hitIndicator); stage.removeChild(hitIndicator); });
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3a162705dd7b5caea61b")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.44704b2c020dd3a4996f.hot-update.js.map