    ...
    checkEquippedWeapon() {
        switch (this._currentWeapon) {
            case Constants_1.PISTOL:
                ...
                this._currentWeaponAmmo = this._pistolAmmo;
                this._pistolAmmo = this._currentWeaponAmmo;
                break;
            case Constants_1.TESLA:
                ...
                this._teslagunAmmo = this._currentWeaponAmmo;
                break;
            case Constants_1.LASER:
                ...
                this._laserAmmo = this._currentWeaponAmmo;
                break;
            case Constants_1.ROCKET:
                ...
                this._rocketAmmo = this._currentWeaponAmmo;
                break;
            case Constants_1.RAILGUN:
                ...
                this._railgunAmmo = this._currentWeaponAmmo;
                break;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d30c9bf27bec47359588")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.545d5aa806931f212e49.hot-update.js.map