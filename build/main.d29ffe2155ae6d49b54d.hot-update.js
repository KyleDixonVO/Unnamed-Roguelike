...
function loadLevel(value) {
    ...
    for (let j = 0; j < Constants_1.HEIGHT_IN_TILES; j++) {
        for (let k = 0; k < Constants_1.WIDTH_IN_TILES; k++) {
            console.log(Constants_1.LEVEL_DATA[0][0][0]);
            tilePool[j][k].sprite.gotoAndStop(Constants_1.LEVEL_DATA[i][j][k]);
        }
    }
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("392c354bec997c074c08")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.d29ffe2155ae6d49b54d.hot-update.js.map