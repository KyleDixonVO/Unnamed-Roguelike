...
function monitorKeys() {
    ...
    if (escapePress == true) {
        if (escapeUp == true || paused == true)
            return;
        console.log("escape toggle active");
        screenManager.openSettings();
    }
    if (escapePress == false || paused == false) {
        if (escapeUp == true)
            return;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d7fb56d4bba3f02b06ef")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.5e05049c9324da24b66a.hot-update.js.map