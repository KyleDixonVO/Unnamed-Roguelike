...
class Enemy extends GameCharacter_1.GameCharacter {
    ...
    takeDamage(value) {
        ...
        if (this.health == 0) {
            this.killed();
            this.stage.dispatchEvent(this.eventEnemyKilled, this.sprite);
        }
    }
}
exports.Enemy = Enemy;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c310d9c239d4b23790b6")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.10c9bc41175c2f43be24.hot-update.js.map