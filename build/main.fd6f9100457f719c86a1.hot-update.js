...
class Enemy extends GameCharacter_1.GameCharacter {
    ...
    update() {
        ...
        ;
        if (this._sprite.x - 0.25 > this.player.sprite.x) {
            this.deltaX = -1;
        }
        else if (this._sprite.x + 0.25 < this.player.sprite.x) {
            this.deltaX = 1;
        }
        else
            (this.deltaX = 0);
        if (this._sprite.y - 0.25 > this.player.sprite.y) {
            this.deltaY = -1;
        }
        else if (this._sprite.y + 0.25 < this.player.sprite.y) {
            this.deltaY = 1;
        }
        else
            (this.deltaY = 0);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b1441da81182b49ae6ab")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.fd6f9100457f719c86a1.hot-update.js.map