...
function projectileEnemyCollision() {
    for (let projectile of projectilePool) {
        ...
        for (let enemy of enemyPool) {
            if (!enemy.used)
                return;
            if ((0, Toolkit_1.radiusHit)(projectile.sprite, 0.1, enemy.sprite, 10)) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3bbf30d92d80941bf467")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.136954a58e231bcba19d.hot-update.js.map