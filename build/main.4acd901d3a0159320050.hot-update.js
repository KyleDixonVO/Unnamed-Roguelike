...
class UserInterface {
    ...
    onSoundDownClick() {
        ...
        this.soundDown.on("click", () => {
            ...
            console.log(this.settings.volume);
            createjs.Sound.play("Select", null, null, null, null, this.settings.volume);
        });
    }
    onSoundUpClick() {
    ...
    showSettingsMenu() {
        ...
        this.soundDown.x = 400;
        this.soundDown.y = 300;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("85808af7919d1292fbd4")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.4acd901d3a0159320050.hot-update.js.map