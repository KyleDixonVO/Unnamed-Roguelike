...
function onReady(e) {
    ...
    for (let i = 0; i < (Constants_1.HEIGHT_IN_TILES); i++) {
        ...
        for (let j = 0; j < Constants_1.WIDTH_IN_TILES; j++) {
            ...
            tilePool[i][j].addToStage();
            tilePool[i][j].setPosition(i * 40 + 40, j * 40 + 40);
        }
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("e95d85f76145f2d167ed")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.8cabaa14908c105d62d8.hot-update.js.map