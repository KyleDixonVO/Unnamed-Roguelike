...
function onGameEvent(e) {
    switch (e.type) {
        ...
        case "playerHit":
            ...
            stage.addChild(hitIndicator);
            createjs.Tween.get(hitIndicator, { useTicks: true }).to({ alpha: 0 }, 30).wait(10).call(() => { createjs.Tween.removeTweens(hitIndicator); stage.removeChild(hitIndicator); });
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d60f8777e21933c6ae41")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.fc958953084d5c277b52.hot-update.js.map