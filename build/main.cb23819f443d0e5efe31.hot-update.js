...
class Player extends GameCharacter_1.GameCharacter {
    ...
    onKilled() {
        ...
        createjs.Tween.get(this._sprite, { useTicks: true }).to({ alpha: 0 }, 30);
        this.dispatchKilled();
    }
    onDamaged() {
    }
    ...
    reset() {
        ...
        createjs.Tween.get(this._sprite, { useTicks: true }).to({ alpha: 1 }, 1);
    }
    takeDamage(value) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a0dad3b827a38fda87d0")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.cb23819f443d0e5efe31.hot-update.js.map