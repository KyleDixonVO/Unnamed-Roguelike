...
class Player extends GameCharacter_1.GameCharacter {
    ...
    onKilled() {
        ...
        createjs.Tween.get(this._sprite, { useTicks: true }).to({ alpha: 0 }, 30).wait(10).dispatchEvent(this.eventKilled);
    }
    onDamaged() {
    }
    onReload() {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a4eddc2b2e3a03002ee7")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.84e49771bcb8eae1e098.hot-update.js.map