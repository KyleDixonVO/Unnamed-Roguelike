...
class Player extends GameCharacter_1.GameCharacter {
    ...
    onKilled() {
        ...
        createjs.Tween.get(this._sprite, { useTicks: true }).to({ alpha: 0 }, 30).wait(100).dispatchEvent(this.eventKilled);
    }
    onDamaged() {
    }
    onReload() {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("84e49771bcb8eae1e098")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.5083e96d4f1aee845afb.hot-update.js.map