...
function onGameEvent(e) {
    ...
    switch (e.type) {
        ...
        case "gameStarted":
            ...
            console.log(playerInventory.currentWeapon);
...
function onAddProjectile() {
    ...
    for (newProjectile of playerProjectilePool) {
        if (newProjectile.used == false) {
            ...
            console.log(newProjectile.controllerInventory.currentProjectileSprite);
            break;
        }
    }
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("417f68297b144c6ff8dc")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.00f0fb12f900ed40b84a.hot-update.js.map