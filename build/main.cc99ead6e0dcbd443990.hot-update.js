...
function projectileEnemyCollision() {
    for (let projectile of playerProjectilePool) {
        ...
        for (let enemy of enemyPool) {
            if (!enemy.used)
                return;
            if ((0, Toolkit_1.radiusHit)(projectile.sprite, 2, enemy.sprite, 32)) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d5d02059db080747af97")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.cc99ead6e0dcbd443990.hot-update.js.map