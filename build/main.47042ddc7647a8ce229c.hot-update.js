...
function tileCollisionDetection() {
    for (let tile of tilePool) {
        for (let i = 0; i < Constants_1.WIDTH_IN_TILES; i++) {
            if (tile[i].sprite.currentAnimation == "sprites/firstplayable/floor 1")
                continue;
            for (let enemy of enemyPool) {
                if (!enemy.used)
                    continue;
            ...
            for (let projectile of playerProjectilePool) {
                ...
                if ((0, Toolkit_1.boxHit)(projectile.sprite, tile[i].sprite)) {
                    projectile.secondaryEffect(tile[i]);
                }
            }
        }
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8b90e2cb61017e73545b")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.47042ddc7647a8ce229c.hot-update.js.map