...
function projectileEnemyCollision() {
    for (let projectile of playerProjectilePool) {
        ...
        for (let enemy of enemyPool) {
            if (!enemy.used)
                return;
            if ((0, Toolkit_1.radiusHit)(projectile.sprite, 4, enemy.sprite, 28)) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b8584292eb821f116a34")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.912b2e0d45758c20cb6a.hot-update.js.map