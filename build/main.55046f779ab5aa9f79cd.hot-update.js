...
function projectileEnemyCollision() {
    for (let projectile of playerProjectilePool) {
        ...
        for (let enemy of enemyPool) {
            if (!enemy.used)
                return;
            if ((0, Toolkit_1.radiusHit)(projectile.sprite, 2, enemy.sprite, 20)) {
...
function projectilePlayerCollision() {
    for (let projectile of projectilePool) {
        if (!projectile.used)
            return;
        if ((0, Toolkit_1.radiusHit)(projectile.sprite, 2, player.sprite, 20)) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d8c1ad4f391f2ad3d738")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.55046f779ab5aa9f79cd.hot-update.js.map