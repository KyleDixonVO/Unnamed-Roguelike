...
class Enemy extends GameCharacter_1.GameCharacter {
    ...
    update() {
        ...
        else if (this.sprite.y < this.player.sprite.y) {
            this.deltaY = 1;
        }
        else
            (this.deltaY = 0);
        this.sprite.x += this.deltaX * this._speed;
        this.sprite.y += this.deltaY * this._speed;
        if (this.player.state == GameCharacter_1.GameCharacter.STATE_DEAD)
            return;
        if ((0, Toolkit_1.boxHit)(this.sprite, this.player.sprite)) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("2c2bf8e7ab2a5287c864")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.af1458205000f38c74ea.hot-update.js.map