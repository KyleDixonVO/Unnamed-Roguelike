...
class Enemy extends GameCharacter_1.GameCharacter {
    ...
    courseCorrect(object) {
        ...
        if (object.sprite.y > this.sprite.y) {
            this.deltaY = -1;
        }
        else {
            this.deltaY = 1;
        }
        let random = (0, Toolkit_1.randomMe)(1, 2);
        console.log(random);
        if (random = 1) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4ddb16d83f99a0c9b8f4")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.b3bdff8daee22cbd3d53.hot-update.js.map